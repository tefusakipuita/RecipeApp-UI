    ...
    static let recipes = [
        RecipeItem(title: "Salmon Greek Salad with Lemon Basil Dressing",
                   ...
                   summery: [
                        ...
                        "alarm" : "35 min",
                        "leaf" : "Fish",
                        "chart.bar.doc.horizontal" : "\(ingredients[0].count) ingredient"
                   ],
                   ingredients: ingredients[0],
                   instructions: steps[0],
                   recipeColor: .orange),
        RecipeItem(title: "Fusilli Pasta with Spinach and Tomatoes",
                   description: "Fusilli Pasta with spinach tomatoes and mushrooms! Make this quick and delicious, easy weeknight dinner! Your family will love this!",
                   imageName: "meal_2",
                   summery: [
                        "x.squareroot" : "Medium",
                        "alarm" : "25 min",
                        "leaf" : "Vegetarian",
                        "chart.bar.doc.horizontal" : "\(ingredients[1].count) ingredient"
                   ],
                   ingredients: ingredients[1],
                   instructions: steps[1],
                   recipeColor: .green),
        RecipeItem(title: "Macadamia-crusted fish with green beans",
                   description: "Macadamia-crusted fish with asparagus and green beans. Melt-in-your mouth fish with a tasty crust is perfect for a nutritious weeknight.",
                   imageName: "meal_3",
                   summery: [
                        "x.squareroot" : "Easy",
                        "alarm" : "15 min",
                        "leaf" : "Fish",
                        "chart.bar.doc.horizontal" : "\(ingredients[2].count) ingredient"
                   ],
                   ingredients: ingredients[2],
                   instructions: steps[2],
                   recipeColor: .pink),
        RecipeItem(title: "Grilled Salmon with Foil-Pack Sesame Broccoli",
                   description: "Grilled salmon come together quickly with just a few simple ingredients. Making this grilled salmon makes it moist, tender.",
                   imageName: "meal_4",
                   summery: [
                        "x.squareroot" : "Medium",
                        "alarm" : "30 min",
                        "leaf" : "Fish",
                        "chart.bar.doc.horizontal" : "\(ingredients[3].count) ingredient"
                   ],
